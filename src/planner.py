...
_Black_Swift = Aircraft(CONST.BLACKSWIFT_ENDURANCE_min, CONST.BLACKSWIFT_WIND_RATING_ms,
                                CONST.BLACKSWIFT_CLIMB_RATE_ms, CONST.BLACKSWIFT_DESCENT_RATE_ms,
                                CONST.BLACKSWIFT_TURN_RADIUS_m, CONST.BLACKSWIFT_TURN_PENALTY_s,
                                CONST.BLACKSWIFT_MIN_GROUND_SPEED_ms, CONST.BLACKSWIFT_CRUISE_SPEED_ms)

#Amount of distance the aircraft can use for its mission (Using the alias function, further docs in aircraft_math.py)
_Black_Swift_usable_endurance_m = max_planned_distance_m(_Black_Swift, CONST.V1_EMERGENCY_RESERVE_FRACTION)

#Step 1.2: Assemble the Sensor object

_Calypso_payload = Sensor(CONST.V1_DEFAULT_SENSOR_CROSS_TRACK_FOV_deg, CONST.V1_DEFAULT_SENSOR_ALONG_TRACK_FOV_DEG, 
                          CONST.V1_DEFAULT_OVERLAP_PCT, CONST.V1_DEFAULT_SENSOR_OFF_NADIR_deg, "Micasense from Grey Paper")

#Step 1.3: Mission Request object for launch, land, and M1, then route assembly:

_V1_Launch_Waypoint = Waypoint("WP000", CONST.V1_LAUNCH_POINT_LAT, CONST.V1_LAUNCH_POINT_LONG, CONST.V1_DEFAULT_AIRCRAFT_ALTITUDE_m,
                               CONST.BLACKSWIFT_CRUISE_SPEED_ms,  CONST.WAYPOINT_ACTION_LAUNCH, "Launch point", "Seymour-Beach-Launch")

_V1_Land_Waypoint = Waypoint("WP_END", CONST.V1_LAND_POINT_LAT, CONST.V1_LAND_POINT_LONG, CONST.V1_DEFAULT_AIRCRAFT_ALTITUDE_m, CONST.BLACKSWIFT_CRUISE_SPEED_ms,
                             CONST.WAYPOINT_ACTION_LAND, "land waypoint", "Seymour-Road-Land")

_V1_M1_Waypoint = Waypoint("WP_M1", CONST.M1_MOORING_LAT, CONST.M1_MOORING_LONG, CONST.V1_DEFAULT_AIRCRAFT_ALTITUDE_m,
                           CONST.BLACKSWIFT_CRUISE_SPEED_ms, CONST.WAYPOINT_ACTION_M1_OVERFLIGHT, "M1 waypoint for overflight req",
                           "M1-Mooring-Station")

_V1_Mission_Request = MissionRequest(mission_name="V1 First Example Mission", launch_waypoint=_V1_Launch_Waypoint, land_waypoint=_V1_Land_Waypoint,
                                     altitude_m=CONST.V1_DEFAULT_AIRCRAFT_ALTITUDE_m, valid_date=mission_date,
                                     require_m1_overflight=True, grid_orientation_deg=None, notes="First Mission",
                                     included_target_waypoints=[_V1_M1_Waypoint])


#Step 1.4: Weather Stub, no API source yet, using conditions at launch point:

_V1_assumed_weather = Weather(CONST.V1_LAUNCH_POINT_LAT, CONST.V1_LAUNCH_POINT_LONG, mission_date,
                              CONST.V1_DEFAULT_MISSION_CLOUD_COVER, CONST.DEFAULT_ZERO_WIND, CONST.DEFAULT_WIND_DIRECTION_deg,
                              CONST.DEFAULT_WIND_GUST_ms, CONST.DEFAULT_VISIBILITY_m, CONST.DEFAULT_WEATHER_CONDITION)


#Step 2: Assemble the current sun state and grab the azimuth.

_V1_mission_sun_state = create_sun_state(CONST.V1_LAUNCH_POINT_LAT, CONST.V1_LAUNCH_POINT_LONG, mission_date)
...
def _score_glint(track_heading_deg, sun_az_deg):
    ...
    return min((abs(azimuth_delta - CONST.AZIMUTH_ONE_THIRTY_FIVE)), (abs(azimuth_delta - CONST.AZIMUTH_TWO_TWENTY_FIVE)))
