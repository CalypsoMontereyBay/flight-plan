...
# Begin setup
setup_keywords = dict()
setup_keywords['name'] = 'flight-plan'
setup_keywords['description'] = 'Calypso Monterey Bay sun-aware UAV flight-planning engine'
setup_keywords['author'] = 'J. Xavier Prochaska'
setup_keywords['author_email'] = 'jxp@ucsc.edu'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/ocean-colour/flight-plan'
